...
class FileAttributes {
    /** Create FileAttributes from String, Array or Buffer
      ...
      * @example
      * const FileAttributes = require('win-lnk/lib/file-attributes')
      * const faFromString = FileAttributes.from('abc')
      * const faFromArray = FileAttributes.from(['readonly', 'b', 'system'])
      * const faFromBuffer = FileAttributes.from(Buffer.from([1, 0, 0, 0]))
      */
    static from(flags) {
        switch (true) {
    ...
    /** Create FileAttributes from array of flags
      ...
      * @example
      * const FileAttributes = require('win-lnk/lib/file-attributes')
      * const faFromArray = FileAttributes.from(['normal', 'hidden'])
      */
    ...
    /** Create FileAttributes from buffer
      ...
      * @example
      * const FileAttributes = require('win-lnk/lib/file-attributes')
      * const faFromBuffer = FileAttributes.from(Buffer.from([0xB7, 0, 0, 0]))
      */
    ...
    /** Convert FileAttributes to String of short flags
      ...
      * @example
      * const FileAttributes = require('win-lnk/lib/file-attributes')
      * const fa = FileAttributes.from('abc')
      * const str = fa.toString()
      */
    toString() {
